...
<div class="heading">
    <h1><i class="fas fa-solid fa-user-nurse"></i>&nbspAdd Nurse</h1>
    <a href="index.php?page=nurses" class="right_button <?= $page == 'nurses' && !isset($_GET['subpage']) ? 'active' : '' ?>">
		<i class="fa fa-list-ol" aria-hidden="true"></i>&nbspNurse List</a>
    <a href="index.php?page=nurses&subpage=add" class="right_button <?= $page == 'nurses' && $subpage == 'add' ? 'active' : '' ?>">
		<i class="fa fa-plus"></i>&nbspAdd Nurse</a>
</div>
